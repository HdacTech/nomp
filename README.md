...
Hdac Node Mining Portal은 오픈 소스를 사용한다.
...
코인 폴더에 수많은 코인들의 설정 파일들이 존재한다. HDAC의 코인 설정 정보는 다음과 같다.
...
다른 코인들의 알고리즘 설정 정보를 세팅하는 방법은 [여기](https://github.com/zone117x/node-stratum-pool#module-usage)를 참조한다.
